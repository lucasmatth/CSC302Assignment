...
with open('total_views_byday.json', 'w', encoding='utf-8') as f:
...
with open('total_likes_byday.json', 'w', encoding='utf-8') as f:
...
with open('total_dislikes_byday.json', 'w', encoding='utf-8') as f:
...
with open('total_rating_byday.json', 'w', encoding='utf-8') as f:
